    ...
    <view className="Signup">
      <view className="SignupHeader">
        ...
        <text className="SignupSubtitle">
          Follow creators and stream micro‑credits as you watch
        </text>
      </view>
      ...
      <view className="FormCard">
        <view className="FormField">
          ...
          <input
            ...
            value={name}
            bindinput={(e: any) =>
              setName(e.detail?.value ?? e.target?.value ?? '')
            }
            bindblur={() => setTouched((v) => ({ ...v, name: true }))}
          />
          {touched.name && !nameValid && (
            <text className="FormError">Please enter your name</text>
          )}
        </view>
        ...
        <view className="FormField">
          ...
          <input
            ...
            bindblur={() =>
              setTouched((v: { name: boolean; email: boolean }) => ({
                ...v,
                email: true,
              }))
            }
        ...
        <view className="FormField">
          ...
          <input
            ...
            value={interests}
            bindinput={(e: any) =>
              setInterests(e.detail?.value ?? e.target?.value ?? '')
            }
          />
          <text className="FormHint">
            Helps personalize creator suggestions
          </text>
        </view>
